    ...
    return (
      <div>
        ...
        <DataGrid data={this.state.data.slice((pageNumber-1)*pageSize,pageNumber*pageSize)} >
          ...
          />
          <GridColumn field="code" title="code" align="center"></GridColumn>
          <GridColumn field="name" title="name" align="center"></GridColumn>
          <GridColumn field="unitcost" title="unitcost" align="center"></GridColumn>
          <GridColumn field="status" title="status" align="center"></GridColumn>
          <GridColumn field="listprice" title="listprice" align="center" ></GridColumn>
          <GridColumn field="attr" title="attr" align="center"></GridColumn>
          <GridColumn field="itemid" title="itemid" align="center"></GridColumn>
